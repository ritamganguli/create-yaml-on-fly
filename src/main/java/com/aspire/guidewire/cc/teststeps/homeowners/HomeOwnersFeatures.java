...
public class HomeOwnersFeatures {
	...
	public static class ChooseCoveragesByType {
		...
		private CoverageType_F coverage_F;
		...
		private Coverage fungusAndMoldRemediation;
		
		private Coverage scheduledPersonalProperty;
	...
	@NoArgsConstructor
	@AllArgsConstructor
	public static class CoverageType_F {
		
		private Coverage medicalPaymentsToOthers;
	...
	public static class CoverageType_C {
		...
		private Coverage personalProperty;		
	}
	@Getter
	@Setter
	@Builder
	...
	public static class CoverageType_E {
		...
		private Coverage personalLiabilityBodilyInjury;
		
		private Coverage personalLiabilityGeneral;
		
		private Coverage personalLiabilityProperty;
	...
	public static class ChooseCoverages {
		...
		private Coverage identityTheftProtection;
		
		private Coverage coverageADwelling;
		
		private Coverage coverageBOtherStructures;
		
		private Coverage coverageCPersonalProperty;
		
		private Coverage coverageDLossOfUse;
	...
	@NoArgsConstructor
	@AllArgsConstructor
	public static class ExposureDataUnavailability{
