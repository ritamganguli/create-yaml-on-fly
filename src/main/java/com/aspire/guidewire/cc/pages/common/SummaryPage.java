...
//	public ClaimSummaryActivities claimsummaryactivitiesTable;
	...
	@IFindBy(how = How.XPATH, using = "//div[text()='Medical Details']//ancestor::div[contains(@id,'Claim_TopLevelExposureDetail')]", AI = false)
	private WebElement btnMedicalDetails;
	...
	@IFindBy(how = How.CSS, using = "div[id$='_ClaimDocuments']", AI = false)
	private WebElement btnDocuments;
	
	@IFindBy(how = How.CSS, using = "div[id$='Body']", AI = false)
	private WebElement lblNoteName;
	
	@IFindBy(how = How.CSS, using = "div[id='Claim-MenuLinks-Claim_ClaimWorkplan']", AI = false)
	private WebElement btnWorkPaln;
	
	@IFindBy(how = How.CSS, using = "div[id$='_ClaimStatus']", AI = false)
	...
	@IFindBy(how = How.CSS, using = "div[id$='NotesLV-0-Body']", AI = false)
...
public MedicalDetailsPage clickMedicalDetails(WebDriver driver)  {
	BrowserActions.click(driver, btnMedicalDetails,"Medical Details");
	return new MedicalDetailsPage(driver).get();
}
public IndemnityPage clickIndemnity(WebDriver driver)  {
	BrowserActions.click(driver, btnIndemnity,1,"Indemnity");
	return new IndemnityPage(driver).get();
}
public DocumentPage clickDocuments(WebDriver driver)  {
	BrowserActions.click(driver, btnDocuments,"Documents");
    return new DocumentPage(driver).get();
}
public SummaryPage verifyNoteCreated(WebDriver driver,String name)  {
	String text = BrowserActions.getText(driver, lblNoteName,"Note name");
	Log.assertThat(text.equals(name), "Note is created", "Note is not Created");
	return this;
}
public WorkplanPage clickWorkPlan(WebDriver driver)  {
	BrowserActions.click(driver, btnWorkPaln,1,"Work Plan");
    return new WorkplanPage(driver).get();
}
public StatusPage clickStatus(WebDriver driver)  {
	BrowserActions.click(driver, btnStatus,1,"Status");
	return new StatusPage(driver).get();
}
public SummaryPage clickCloseExposure(WebDriver driver)  {
	BrowserActions.click(driver, btnCloseExposure,"CloseExposure");
    return this;
}
public SummaryPage clickSummary(WebDriver driver)  {
