...
public class ContactInformationPage extends LoadableComponent<ContactInformationPage> {
	...
	@IFindBy(how = How.CSS, using = "div[id$='tb-Add']", AI = false)
	...
	}public ContactInformationPage selectHomeRegionCode(WebDriver driver,String HomeRegionCode)  {
		BrowserActions.selectDropDownByVisibleText(driver, drpHomeRegionCode,HomeRegionCode,"HomeRegionCode");
		return this;
	}
	public ContactInformationPage enterStatus(WebDriver driver,String Status) {
		BrowserActions.type(driver, inpStatus,Status, "Status");
		return this;
	}
	public ContactInformationPage enterWork_3(WebDriver driver,String Work_3) {
		BrowserActions.type(driver, inpWork_3,Work_3, "Work_3");
		return this;
	}
	public ContactInformationPage clickCancel_11(WebDriver driver)  {
		BrowserActions.click(driver, btnCancel_11,"Cancel_11");
		return this;
	}
	public ContactInformationPage clickAutoRepairService(WebDriver driver)  {
		BrowserActions.click(driver, btnAutoRepairService,"AutoRepairService");
		return this;
	}
	public ContactInformationPage clickW9ValidtoDateIcon(WebDriver driver)  {
		BrowserActions.click(driver, btnW9ValidtoDateIcon,"W9ValidtoDateIcon");
		return this;
	}
	public ContactInformationPage clickReview(WebDriver driver)  {
		BrowserActions.click(driver, btnReview,"Review");
		return this;
	}
	public ContactInformationPage enterClaimInvolvementEnd(WebDriver driver,String ClaimInvolvementEnd) {
		BrowserActions.type(driver, inpClaimInvolvementEnd,ClaimInvolvementEnd, "ClaimInvolvementEnd");
		return this;
	}
	public ContactInformationPage clickViewContactDetails(WebDriver driver)  {
		BrowserActions.click(driver, btnViewContactDetails,"ViewContactDetails");
		return this;
	}
	public ContactInformationPage selectJurisdiction_36(WebDriver driver,String Jurisdiction_36)  {
		BrowserActions.selectDropDownByVisibleText(driver, drpJurisdiction_36,Jurisdiction_36,"Jurisdiction_36");
		return this;
	}
	public ContactInformationPage clickW9Received(WebDriver driver)  {
		BrowserActions.click(driver, rdbW9Received,"W9Received");
		return this;
	}
	public ContactInformationPage selectState_28(WebDriver driver,String State_28)  {
		BrowserActions.selectDropDownByVisibleText(driver, drpState_28,State_28,"State_28");
		return this;
	}
	public ContactInformationPage clickUnlink_42(WebDriver driver)  {
		BrowserActions.click(driver, btnUnlink_42,"Unlink_42");
		return this;
	}
	public ContactInformationPage clickViewinAddressBook_59(WebDriver driver)  {
		BrowserActions.click(driver, btnViewinAddressBook_59,"ViewinAddressBook_59");
		return this;
	}
	public ContactInformationPage clickClaimInvolvementEndDateIcon(WebDriver driver)  {
		BrowserActions.click(driver, btnClaimInvolvementEndDateIcon,"ClaimInvolvementEndDateIcon");
		return this;
	}
	public ContactInformationPage enterValiduntil_33(WebDriver driver,String Validuntil_33) {
		BrowserActions.type(driver, inpValiduntil_33,Validuntil_33, "Validuntil_33");
		return this;
	}
	public ContactInformationPage enterHome_4(WebDriver driver,String Home_4) {
		BrowserActions.type(driver, inpHome_4,Home_4, "Home_4");
		return this;
	}
	public ContactInformationPage enterWorkExtension(WebDriver driver,String WorkExtension) {
		BrowserActions.type(driver, inpWorkExtension,WorkExtension, "WorkExtension");
		return this;
	}
	public ContactInformationPage clickUpdate_10(WebDriver driver)  {
		BrowserActions.click(driver, btnUpdate_10,"Update_10");
		return this;
	}
	public ContactInformationPage clickEdit_38(WebDriver driver)  {
		BrowserActions.click(driver, btnEdit_38,"Edit_38");
		return this;
	}
	public ContactInformationPage clickRemove_47(WebDriver driver)  {
		BrowserActions.click(driver, btnRemove_47,"Remove_47");
		return this;
	}
	public ContactInformationPage clickLink(WebDriver driver)  {
		BrowserActions.click(driver, btnLink,"Link");
		return this;
	}
	public ContactInformationPage clickPreferredVendor(WebDriver driver)  {
		BrowserActions.click(driver, rdbPreferredVendor,"PreferredVendor");
		return this;
	}
	public ContactInformationPage enterTaxIDEIN(WebDriver driver,String TaxIDEIN) {
		BrowserActions.type(driver, inpTaxIDEIN,TaxIDEIN, "TaxIDEIN");
		return this;
	}
	public ContactInformationPage clickRemove_7(WebDriver driver)  {
		BrowserActions.click(driver, btnRemove_7,"Remove_7");
		return this;
	}
	public ContactInformationPage selectFaxRegionCode(WebDriver driver,String FaxRegionCode)  {
		BrowserActions.selectDropDownByVisibleText(driver, drpFaxRegionCode,FaxRegionCode,"FaxRegionCode");
		return this;
	}
	public ContactInformationPage selectAddressType(WebDriver driver,String AddressType)  {
		BrowserActions.selectDropDownByVisibleText(driver, drpAddressType,AddressType,"AddressType");
		return this;
	}
	public ContactInformationPage clickW9ValidfromDateIcon(WebDriver driver)  {
		BrowserActions.click(driver, btnW9ValidfromDateIcon,"W9ValidfromDateIcon");
		return this;
	}
	public ContactInformationPage selectAddressBookContactMattersFilterSet_51(WebDriver driver,String AddressBookContactMattersFilterSet_51)  {
	...
	public ContactInformationPage enterLocation_20(WebDriver driver,String Location_20) {
		BrowserActions.type(driver, inpLocation_20,Location_20, "Location_20");
		return this;
	}
	public ContactInformationPage selectCountry_21(WebDriver driver,String Country_21)  {
		BrowserActions.selectDropDownByVisibleText(driver, drpCountry_21,Country_21,"Country_21");
		return this;
	}
	public ContactInformationPage selectLocation(WebDriver driver,String Location)  {
		BrowserActions.selectDropDownByVisibleText(driver, drpLocation,Location,"Location");
		return this;
	}
	public ContactInformationPage clickCheckforDuplicates(WebDriver driver)  {
		BrowserActions.click(driver, btnCheckforDuplicates,"CheckforDuplicates");
		return this;
	}
	public ContactInformationPage clickUpdate_8(WebDriver driver)  {
		BrowserActions.click(driver, btnUpdate_8,"Update_8");
		return this;
	}
	public ContactInformationPage enterZIPCode(WebDriver driver,String ZIPCode) {
		BrowserActions.type(driver, inpZIPCode,ZIPCode, "ZIPCode");
		return this;
	}
	public ContactInformationPage clickEdit_9(WebDriver driver)  {
		BrowserActions.click(driver, btnEdit_9,"Edit_9");
		return this;
	}
	public ContactInformationPage enterClaim(WebDriver driver,String Claim) {
		BrowserActions.type(driver, inpClaim,Claim, "Claim");
		return this;
	}
	public ContactInformationPage enterValiduntil(WebDriver driver,String Validuntil) {
		BrowserActions.type(driver, inpValiduntil,Validuntil, "Validuntil");
		return this;
	}
	public ContactInformationPage enterFax(WebDriver driver,String Fax) {
		BrowserActions.type(driver, inpFax,Fax, "Fax");
		return this;
	}
	public ContactInformationPage selectAddressBookContactActivitiesFilterSet_48(WebDriver driver,String AddressBookContactActivitiesFilterSet_48)  {
	...
	public ContactInformationPage clickUpdate_1(WebDriver driver)  {
		BrowserActions.click(driver, btnUpdate_1,"Update_1");
		return this;
	}
	public ContactInformationPage enterW9ReceivedDate(WebDriver driver,String W9ReceivedDate) {
		BrowserActions.type(driver, inpW9ReceivedDate,W9ReceivedDate, "W9ReceivedDate");
		return this;
	}
	public ContactInformationPage selectWorkRegionCode(WebDriver driver,String WorkRegionCode)  {
		BrowserActions.selectDropDownByVisibleText(driver, drpWorkRegionCode,WorkRegionCode,"WorkRegionCode");
		return this;
	}
	public ContactInformationPage enterLocationCode_35(WebDriver driver,String LocationCode_35) {
		BrowserActions.type(driver, inpLocationCode_35,LocationCode_35, "LocationCode_35");
		return this;
	}
	public ContactInformationPage clickAddresses(WebDriver driver)  {
		BrowserActions.click(driver, btnAddresses,"Addresses");
		return this;
	}
	public ContactInformationPage clickEdit_53(WebDriver driver)  {
		BrowserActions.click(driver, btnEdit_53,"Edit_53");
		return this;
	}
	public ContactInformationPage clickCopyfromAddressBook_58(WebDriver driver)  {
		BrowserActions.click(driver, btnCopyfromAddressBook_58,"CopyfromAddressBook_58");
		return this;
	}
	public ContactInformationPage selectCountry(WebDriver driver,String Country)  {
		BrowserActions.selectDropDownByVisibleText(driver, drpCountry,Country,"Country");
		return this;
	}
	public ContactInformationPage clickUnlink_57(WebDriver driver)  {
		BrowserActions.click(driver, btnUnlink_57,"Unlink_57");
		return this;
	}
	public ContactInformationPage selectState(WebDriver driver,String State)  {
		BrowserActions.selectDropDownByVisibleText(driver, drpState,State,true,"State");
		return this;
	}
	public ContactInformationPage selectAddressBookContactMattersFilterSet(WebDriver driver,String AddressBookContactMattersFilterSet)  {
	...
	public ContactInformationPage clickCancel_40(WebDriver driver)  {
		BrowserActions.click(driver, btnCancel_40,"Cancel_40");
		return this;
	}
	public ContactInformationPage enterNotes(WebDriver driver,String Notes) {
		BrowserActions.type(driver, inpNotes,Notes, "Notes");
		return this;
	}
	public ContactInformationPage clickViewinAddressBook_44(WebDriver driver)  {
		BrowserActions.click(driver, btnViewinAddressBook_44,"ViewinAddressBook_44");
		return this;
	}
	public ContactInformationPage selectAddressType_31(WebDriver driver,String AddressType_31)  {
		BrowserActions.selectDropDownByVisibleText(driver, drpAddressType_31,AddressType_31,"AddressType_31");
		return this;
	}
	public ContactInformationPage clickCancel_55(WebDriver driver)  {
		BrowserActions.click(driver, btnCancel_55,"Cancel_55");
		return this;
	}
	public ContactInformationPage clickExposures(WebDriver driver)  {
		BrowserActions.click(driver, btnExposures,"Exposures");
		return this;
	}
	public ContactInformationPage clickServiceDateDateIcon(WebDriver driver)  {
		BrowserActions.click(driver, btnServiceDateDateIcon,"ServiceDateDateIcon");
		return this;
	}
	public ContactInformationPage clickViewinAddressBook_15(WebDriver driver)  {
		BrowserActions.click(driver, btnViewinAddressBook_15,"ViewinAddressBook_15");
		return this;
	}
	public ContactInformationPage clickRelatedContacts(WebDriver driver)  {
		BrowserActions.click(driver, btnRelatedContacts,"RelatedContacts");
		return this;
	}
	public ContactInformationPage clickUpdate_52(WebDriver driver)  {
		BrowserActions.click(driver, btnUpdate_52,"Update_52");
		return this;
	}
	public ContactInformationPage clickCheckforDuplicates_16(WebDriver driver)  {
		BrowserActions.click(driver, btnCheckforDuplicates_16,"CheckforDuplicates_16");
		return this;
	}
	public ContactInformationPage clickShowClaimsButton(WebDriver driver)  {
		BrowserActions.click(driver, btnShowClaimsButton,"ShowClaimsButton");
		return this;
	}
	public ContactInformationPage clickUpdate_54(WebDriver driver)  {
		BrowserActions.click(driver, btnUpdate_54,"Update_54");
		return this;
	}
	public ContactInformationPage clickLink_56(WebDriver driver)  {
		BrowserActions.click(driver, btnLink_56,"Link_56");
		return this;
	}
	public ContactInformationPage clickClaims(WebDriver driver)  {
		BrowserActions.click(driver, btnClaims,"Claims");
		return this;
	}
	public ContactInformationPage clickActivities(WebDriver driver)  {
		BrowserActions.click(driver, btnActivities,"Activities");
		return this;
	}
	public ContactInformationPage clickReviews(WebDriver driver)  {
		BrowserActions.click(driver, btnReviews,"Reviews");
		return this;
	}
	public ContactInformationPage enterLocation(WebDriver driver,String Location) {
		BrowserActions.type(driver, inpLocation,Location, "Location");
		return this;
	}
	public ContactInformationPage selectAddressBookContactClaimsFilterSet(WebDriver driver,String AddressBookContactClaimsFilterSet)  {
	...
	public ContactInformationPage clickReturntoContacts(WebDriver driver)  {
		BrowserActions.click(driver, btnReturntoContacts,"ReturntoContacts");
		return this;
	}
	public ContactInformationPage clickEdit(WebDriver driver)  {
		BrowserActions.click(driver, btnEdit,"Edit");
		return this;
	}
	public ContactInformationPage clickUpdate(WebDriver driver)  {
		BrowserActions.click(driver, btnUpdate,true,"Update");
		return this;
	}
	public ContactInformationPage enterAlternateEmail(WebDriver driver,String AlternateEmail) {
		BrowserActions.type(driver, inpAlternateEmail,AlternateEmail, "AlternateEmail");
		return this;
	}
	public ContactInformationPage clickUpdate_39(WebDriver driver)  {
		BrowserActions.click(driver, btnUpdate_39,"Update_39");
		return this;
	}
	public ContactInformationPage clickBasics(WebDriver driver)  {
		BrowserActions.click(driver, btnBasics,"Basics");
		return this;
	}
	public ContactInformationPage clickAutoFillIcon_30(WebDriver driver)  {
		BrowserActions.click(driver, btnAutoFillIcon_30,"AutoFillIcon_30");
		return this;
	}
	public ContactInformationPage clickRemove(WebDriver driver)  {
		BrowserActions.click(driver, btnRemove,"Remove");
		return this;
	}
	public ContactInformationPage clickValiduntilDateIcon_34(WebDriver driver)  {
		BrowserActions.click(driver, btnValiduntilDateIcon_34,"ValiduntilDateIcon_34");
		return this;
	}
	public ContactInformationPage selectRelatedTo(WebDriver driver,String RelatedTo)  {
		BrowserActions.selectDropDownByVisibleText(driver, drpRelatedTo,RelatedTo,"RelatedTo");
		return this;
	}
	public ContactInformationPage clickAdd_6(WebDriver driver)  {
		BrowserActions.click(driver, btnAdd_6,"Add_6");
		return this;
	}
	public ContactInformationPage enterClaimInvolvementStart(WebDriver driver,String ClaimInvolvementStart) {
		BrowserActions.type(driver, inpClaimInvolvementStart,ClaimInvolvementStart, "ClaimInvolvementStart");
		return this;
	}
	public ContactInformationPage clickMatters(WebDriver driver)  {
		BrowserActions.click(driver, btnMatters,"Matters");
		return this;
	}
	public ContactInformationPage clickUpdate_37(WebDriver driver)  {
		BrowserActions.click(driver, btnUpdate_37,"Update_37");
		return this;
	}
	public ContactInformationPage enterReviewScore(WebDriver driver,String ReviewScore) {
		BrowserActions.type(driver, inpReviewScore,ReviewScore, "ReviewScore");
		return this;
	}
	public ContactInformationPage clickValiduntilDateIcon(WebDriver driver)  {
		BrowserActions.click(driver, btnValiduntilDateIcon,"ValiduntilDateIcon");
		return this;
	}
	public ContactInformationPage clickCancel(WebDriver driver)  {
		BrowserActions.click(driver, btnCancel,"Cancel");
		return this;
	}
	public ContactInformationPage clickCopyfromAddressBook(WebDriver driver)  {
		BrowserActions.click(driver, btnCopyfromAddressBook,"CopyfromAddressBook");
		return this;
	}
	public ContactInformationPage clickShowActivitiesButton(WebDriver driver)  {
		BrowserActions.click(driver, btnShowActivitiesButton,"ShowActivitiesButton");
		return this;
	}
	public ContactInformationPage enterZIPCode_29(WebDriver driver,String ZIPCode_29) {
		BrowserActions.type(driver, inpZIPCode_29,ZIPCode_29, "ZIPCode_29");
		return this;
	}
	public ContactInformationPage enterMainEmail(WebDriver driver,String MainEmail) {
		BrowserActions.type(driver, inpMainEmail,MainEmail, "MainEmail");
		return this;
	}
	public ContactInformationPage selectLocation_19(WebDriver driver,String Location_19)  {
		BrowserActions.selectDropDownByVisibleText(driver, drpLocation_19,Location_19,"Location_19");
		return this;
	}
	public ContactInformationPage enterLocationDescription_32(WebDriver driver,String LocationDescription_32) {
		BrowserActions.type(driver, inpLocationDescription_32,LocationDescription_32, "LocationDescription_32");
		return this;
	}
	public ContactInformationPage clickAutoFillIcon_26(WebDriver driver)  {
		BrowserActions.click(driver, btnAutoFillIcon_26,"AutoFillIcon_26");
		return this;
	}
	public ContactInformationPage clickCheckforDuplicates_45(WebDriver driver)  {
		BrowserActions.click(driver, btnCheckforDuplicates_45,"CheckforDuplicates_45");
		return this;
	}
	public ContactInformationPage enterVendor(WebDriver driver,String Vendor) {
		BrowserActions.type(driver, inpVendor,Vendor, "Vendor");
		return this;
	}
	public ContactInformationPage selectAddressBookContactActivitiesFilterSet(WebDriver driver,String AddressBookContactActivitiesFilterSet)  {
	...
	public ContactInformationPage enterFax_5(WebDriver driver,String Fax_5) {
		BrowserActions.type(driver, inpFax_5,Fax_5, "Fax_5");
		return this;
	}
	public ContactInformationPage enterReviewedBy(WebDriver driver,String ReviewedBy) {
		BrowserActions.type(driver, inpReviewedBy,ReviewedBy, "ReviewedBy");
		return this;
	}
	public ContactInformationPage enterLinkStatusMessage(WebDriver driver,String LinkStatusMessage) {
		BrowserActions.type(driver, inpLinkStatusMessage,LinkStatusMessage, "LinkStatusMessage");
		return this;
	}
	public ContactInformationPage enterReviewType(WebDriver driver,String ReviewType) {
		BrowserActions.type(driver, inpReviewType,ReviewType, "ReviewType");
		return this;
	}
	public ContactInformationPage enterFaxExtension(WebDriver driver,String FaxExtension) {
		BrowserActions.type(driver, inpFaxExtension,FaxExtension, "FaxExtension");
		return this;
	}
	public ContactInformationPage clickSearch_64(WebDriver driver)  {
		BrowserActions.click(driver, btnSearch_64,"Search_64");
		return this;
	}
	public ContactInformationPage enterHome(WebDriver driver,String Home) {
		BrowserActions.type(driver, inpHome,Home, "Home");
		return this;
	}
	public ContactInformationPage clickAutoFillIcon_2(WebDriver driver)  {
		BrowserActions.click(driver, btnAutoFillIcon_2,"AutoFillIcon_2");
		return this;
	}
	public ContactInformationPage selectJurisdiction(WebDriver driver,String Jurisdiction)  {
		BrowserActions.selectDropDownByVisibleText(driver, drpJurisdiction,Jurisdiction,"Jurisdiction");
		return this;
	}
	public ContactInformationPage enterCounty(WebDriver driver,String County) {
		BrowserActions.type(driver, inpCounty,County, "County");
		return this;
	}
	public ContactInformationPage clickW9ReceivedDateDateIcon(WebDriver driver)  {
		BrowserActions.click(driver, btnW9ReceivedDateDateIcon,"W9ReceivedDateDateIcon");
		return this;
	}
	public ContactInformationPage clickClaimInvolvementStartDateIcon(WebDriver driver)  {
		BrowserActions.click(driver, btnClaimInvolvementStartDateIcon,"ClaimInvolvementStartDateIcon");
		return this;
	}
	public ContactInformationPage clickShowExposuresButton(WebDriver driver)  {
		BrowserActions.click(driver, btnShowExposuresButton,"ShowExposuresButton");
		return this;
	}
	public ContactInformationPage enterLocationCode(WebDriver driver,String LocationCode) {
		BrowserActions.type(driver, inpLocationCode,LocationCode, "LocationCode");
		return this;
	}
	public ContactInformationPage selectReviewsFilter(WebDriver driver,String ReviewsFilter)  {
		BrowserActions.selectDropDownByVisibleText(driver, drpReviewsFilter,ReviewsFilter,"ReviewsFilter");
		return this;
	}
	public ContactInformationPage clickContactProhibited(WebDriver driver)  {
		BrowserActions.click(driver, rdbContactProhibited,"ContactProhibited");
		return this;
	}
	public ContactInformationPage enterAddress1_22(WebDriver driver,String Address1_22) {
		BrowserActions.type(driver, inpAddress1_22,Address1_22, "Address1_22");
		return this;
	}
	public ContactInformationPage clickLink_12(WebDriver driver)  {
		BrowserActions.click(driver, btnLink_12,"Link_12");
		return this;
	}
	public ContactInformationPage clickNewPerson(WebDriver driver)  {
		BrowserActions.click(driver, btnNewPerson,"NewPerson");
		return this;
	}
	public ContactInformationPage enterCity_25(WebDriver driver,String City_25) {
		BrowserActions.type(driver, inpCity_25,City_25, "City_25");
		return this;
	}
	public ContactInformationPage clickLink_41(WebDriver driver)  {
		BrowserActions.click(driver, btnLink_41,"Link_41");
		return this;
	}
	public ContactInformationPage enterAddress3(WebDriver driver,String Address3) {
		BrowserActions.type(driver, inpAddress3,Address3, "Address3");
		return this;
	}
	public ContactInformationPage enterLocationDescription(WebDriver driver,String LocationDescription) {
		BrowserActions.type(driver, inpLocationDescription,LocationDescription, "LocationDescription");
		return this;
	}
	public ContactInformationPage enterAddress2_23(WebDriver driver,String Address2_23) {
		BrowserActions.type(driver, inpAddress2_23,Address2_23, "Address2_23");
		return this;
	}
	public ContactInformationPage enterAddress1(WebDriver driver,String Address1) {
		BrowserActions.type(driver, inpAddress1,Address1, "Address1");
		return this;
	}
	public ContactInformationPage enterAddress2(WebDriver driver,String Address2) {
		BrowserActions.type(driver, inpAddress2,Address2, "Address2");
		return this;
	}
	public ContactInformationPage clickCheckforDuplicates_60(WebDriver driver)  {
		BrowserActions.click(driver, btnCheckforDuplicates_60,"CheckforDuplicates_60");
		return this;
	}
	public ContactInformationPage enterMobile(WebDriver driver,String Mobile) {
		BrowserActions.type(driver, inpMobile,Mobile, "Mobile");
		return this;
	}
	public ContactInformationPage selectPreferredCurrency(WebDriver driver,String PreferredCurrency)  {
		BrowserActions.selectDropDownByVisibleText(driver, drpPreferredCurrency,PreferredCurrency,"PreferredCurrency");
		return this;
	}
	public ContactInformationPage enterAdjustersComments(WebDriver driver,String AdjustersComments) {
		BrowserActions.type(driver, inpAdjustersComments,AdjustersComments, "AdjustersComments");
		return this;
	}
	public ContactInformationPage clickAutoFillIcon(WebDriver driver)  {
		BrowserActions.click(driver, btnAutoFillIcon,"AutoFillIcon");
		return this;
	}
	public ContactInformationPage selectAddressBookContactClaimsFilterSet_49(WebDriver driver,String AddressBookContactClaimsFilterSet_49)  {
	...
	public ContactInformationPage clickDocuments(WebDriver driver)  {
		BrowserActions.click(driver, btnDocuments,"Documents");
		return this;
	}
	public ContactInformationPage enterLinkStatusRelationshipsMessage(WebDriver driver,String LinkStatusRelationshipsMessage) {
	...
	public ContactInformationPage enterW9Validto(WebDriver driver,String W9Validto) {
		BrowserActions.type(driver, inpW9Validto,W9Validto, "W9Validto");
		return this;
	}
	public ContactInformationPage enterName(WebDriver driver,String Name) {
		BrowserActions.type(driver, inpName,Name, "Name");
		return this;
	}
	public ContactInformationPage enterMobileExtension(WebDriver driver,String MobileExtension) {
		BrowserActions.type(driver, inpMobileExtension,MobileExtension, "MobileExtension");
		return this;
	}
	public ContactInformationPage enterW9Validfrom(WebDriver driver,String W9Validfrom) {
		BrowserActions.type(driver, inpW9Validfrom,W9Validfrom, "W9Validfrom");
		return this;
	}
	public ContactInformationPage enterBusinessLicense(WebDriver driver,String BusinessLicense) {
		BrowserActions.type(driver, inpBusinessLicense,BusinessLicense, "BusinessLicense");
		return this;
	}
	public ContactInformationPage enterServicedBy(WebDriver driver,String ServicedBy) {
		BrowserActions.type(driver, inpServicedBy,ServicedBy, "ServicedBy");
		return this;
	}
	public ContactInformationPage clickAdd(WebDriver driver)  {
		BrowserActions.click(driver, btnAdd,"Add");
		return this;
	}
	public ContactInformationPage selectPrimaryphone(WebDriver driver,String Primaryphone)  {
		BrowserActions.selectDropDownByVisibleText(driver, drpPrimaryphone,Primaryphone,"Primaryphone");
		return this;
	}
	public ContactInformationPage enterServiceDate(WebDriver driver,String ServiceDate) {
		BrowserActions.type(driver, inpServiceDate,ServiceDate, "ServiceDate");
		return this;
	}
	public ContactInformationPage clickEdit_63(WebDriver driver)  {
		BrowserActions.click(driver, btnEdit_63,"Edit_63");
		return this;
	}
	public ContactInformationPage enterCity(WebDriver driver,String City) {
		BrowserActions.type(driver, inpCity,City, true,"City");
		return this;
	}
	public ContactInformationPage clickAdd_46(WebDriver driver)  {
		BrowserActions.click(driver, btnAdd_46,"Add_46");
		return this;
	}
	public ContactInformationPage selectServiceType(WebDriver driver,String ServiceType)  {
		BrowserActions.selectDropDownByVisibleText(driver, drpServiceType,ServiceType,"ServiceType");
		return this;
	}
	public ContactInformationPage clickSearch(WebDriver driver)  {
		BrowserActions.click(driver, btnSearch,"Search");
		return this;
	}
	public ContactInformationPage clickAddNewReview(WebDriver driver)  {
		BrowserActions.click(driver, btnAddNewReview,"AddNewReview");
		return this;
	}
	public ContactInformationPage clickShowMattersButton(WebDriver driver)  {
		BrowserActions.click(driver, btnShowMattersButton,"ShowMattersButton");
		return this;
	}
	public ContactInformationPage clickPrimaryContactMenuIcon(WebDriver driver)  {
		BrowserActions.click(driver, btnPrimaryContactMenuIcon,"PrimaryContactMenuIcon");
		return this;
	}
	public ContactInformationPage selectAddressBookContactExposuresFilterSet(WebDriver driver,String AddressBookContactExposuresFilterSet)  {
	...
	public ContactInformationPage selectReviewsFilter_62(WebDriver driver,String ReviewsFilter_62)  {
		BrowserActions.selectDropDownByVisibleText(driver, drpReviewsFilter_62,ReviewsFilter_62,"ReviewsFilter_62");
		return this;
	}
	public ContactInformationPage enterOverallReviewScore(WebDriver driver,String OverallReviewScore) {
		BrowserActions.type(driver, inpOverallReviewScore,OverallReviewScore, "OverallReviewScore");
		return this;
	}
	public ContactInformationPage enterHomeExtension(WebDriver driver,String HomeExtension) {
		BrowserActions.type(driver, inpHomeExtension,HomeExtension, "HomeExtension");
		return this;
	}
	public ContactInformationPage selectTaxStatus(WebDriver driver,String TaxStatus)  {
		BrowserActions.selectDropDownByVisibleText(driver, drpTaxStatus,TaxStatus,"TaxStatus");
		return this;
	}
	public ContactInformationPage clickCopyfromAddressBook_43(WebDriver driver)  {
		BrowserActions.click(driver, btnCopyfromAddressBook_43,"CopyfromAddressBook_43");
		return this;
	}
	public ContactInformationPage clickAdd_17(WebDriver driver)  {
		BrowserActions.click(driver, btnAdd_17,"Add_17");
		return this;
	}
	public ContactInformationPage clickCompleteSelected(WebDriver driver)  {
		BrowserActions.click(driver, btnCompleteSelected,"CompleteSelected");
		return this;
	}
	public ContactInformationPage enterMobilePhoneNumber(WebDriver driver,String MobilePhoneNumber) {
		BrowserActions.type(driver, inpMobilePhoneNumber,MobilePhoneNumber, "MobilePhoneNumber");
		return this;
	}
	public ContactInformationPage selectMobileRegionCode(WebDriver driver,String MobileRegionCode)  {
		BrowserActions.selectDropDownByVisibleText(driver, drpMobileRegionCode,MobileRegionCode,"MobileRegionCode");
		return this;
	}
	public ContactInformationPage clickAddressDetail(WebDriver driver)  {
		BrowserActions.click(driver, btnAddressDetail,"AddressDetail");
		return this;
	}
	public ContactInformationPage clickRemove_18(WebDriver driver)  {
		BrowserActions.click(driver, btnRemove_18,"Remove_18");
		return this;
	}
	public ContactInformationPage clickDelete(WebDriver driver)  {
		BrowserActions.click(driver, btnDelete,"Delete");
		return this;
	}
	public ContactInformationPage clickViewinAddressBook(WebDriver driver)  {
		BrowserActions.click(driver, btnViewinAddressBook,"ViewinAddressBook");
		return this;
	}
	public ContactInformationPage selectPrimaryContact(WebDriver driver,String PrimaryContact)  {
		BrowserActions.selectDropDownByVisibleText(driver, drpPrimaryContact,PrimaryContact,"PrimaryContact");
		return this;
	}
	public ContactInformationPage clickAddNewReview_61(WebDriver driver)  {
		BrowserActions.click(driver, btnAddNewReview_61,"AddNewReview_61");
		return this;
	}
	public ContactInformationPage selectAddressBookContactExposuresFilterSet_50(WebDriver driver,String AddressBookContactExposuresFilterSet_50)  {
	...
	public ContactInformationPage clickCopyfromAddressBook_14(WebDriver driver)  {
		BrowserActions.click(driver, btnCopyfromAddressBook_14,"CopyfromAddressBook_14");
		return this;
	}
	public ContactInformationPage enterAddress3_24(WebDriver driver,String Address3_24) {
		BrowserActions.type(driver, inpAddress3_24,Address3_24, "Address3_24");
		return this;
	}
	public ContactInformationPage enterWork(WebDriver driver,String Work) {
		BrowserActions.type(driver, inpWork,Work, "Work");
		return this;
	}
	public ContactInformationPage clickUnlink_13(WebDriver driver)  {
		BrowserActions.click(driver, btnUnlink_13,"Unlink_13");
		return this;
	}
	public ContactInformationPage enterCounty_27(WebDriver driver,String County_27) {
		BrowserActions.type(driver, inpCounty_27,County_27, "County_27");
		return this;
	}
	public ContactInformationPage clickUnlink(WebDriver driver)  {
		BrowserActions.click(driver, btnUnlink,"Unlink");
		return this;
	}
	public ContactInformationPage selectRoles(WebDriver driver, String role)  {
		BrowserActions.selectDropDownByVisibleText(driver, drpRoles,role,"Roles");
		return this;
	}
	public ContactInformationPage enterFirstname(WebDriver driver, String name)  {
		BrowserActions.type(driver,inpFirstName ,name,"First name");
		return this;
	}
	public ContactInformationPage enterLastname(WebDriver driver, String name)  {
		BrowserActions.type(driver,inpLastName ,name,"Last name");
		return this;
	}
	public ContactInformationPage enterTaxIDSSN(WebDriver driver, String id)  {
		BrowserActions.type(driver,inpTaxIDSSN ,id,"Tax id SSN");
		return this;
	}
	public ContactInformationPage enterSSN(WebDriver driver, String id)  {
