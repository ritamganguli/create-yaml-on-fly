...
public class BatchProcessInfoPage extends LoadableComponent<BatchProcessInfoPage> {
	...
	@IFindBy(how = How.CSS, using = "div[id$='Scheduler']", AI = false)
	private WebElement btnScheduler;
	...
	public String suspendScheduler ="#BatchProcessInfo-BatchProcessScreen-BatchProcessesLV_tb-suspendScheduler>div[role='button']";
	...
	public BatchProcessInfoPage clickSuspendScheduler(WebDriver driver,String Text)  {
		By suspendSchedulerBy = By.cssSelector(suspendScheduler);
		int size = BrowserActions.getWebElementSize(driver, suspendSchedulerBy,"suspend SchedulerBy",0.5);
		if(size==0){
			BrowserActions.click(driver, btnResumeScheduler,1,"ResumeScheduler");
		}
	...
	public DownloadHistoryPage clickBatchProcessDownloadHistory(WebDriver driver,String batchProcess)  {
		By btnDownloadHistoryBy = By.xpath("//div[text()='"+batchProcess+"']//ancestor::td//following-sibling::td[contains(@id,'RunBatchWithoutNotify')]//child::div[text()='Download History']");//Financials Escalation
		BrowserActions.waitForElementToDisplay(driver, btnDownloadHistoryBy, "Download history");
		WebElement btnDownloadHistory = btnDownloadHistoryBy.findElement(driver);
		BrowserActions.click(driver, btnDownloadHistory,"Download History Button");
		Log.messageStep("Download History Button is Clicked to Download the Batch",DriverManager.getDriver());
		return new DownloadHistoryPage(driver).get();
	}
	...
	public BatchProcessInfoPage clickBatchProcessRunButton(WebDriver driver,String batchProcess)  {
		By btnRunBy = By.xpath("//div[text()='"+batchProcess+"']//ancestor::td//following-sibling::td[contains(@id,'RunBatchWithoutNotify')]//child::div[text()='Run']");
		BrowserActions.waitForElementToDisplay(driver, btnRunBy, "run by");
	...
	public BatchProcessInfoPage verifyBatchProcessLastRun(WebDriver driver,String batchProcess) {
		By btnRun = By.xpath("//div[text()='"+batchProcess+"']//ancestor::td//following-sibling::td[contains(@id,'LastRun_Cell')]");//Financials Escalation
		BrowserActions.waitForElementToDisplay(driver, btnRun,"Last Run");
		return this;
	}
	...
	public BatchProcessInfoPage verifyDownloadButton(WebDriver driver)  {
		BrowserActions.verifyElementDisplayed(driver, btnDownload,"Download",2);
		return this;
	}
	public BatchProcessInfoPage verifySchedulerButton(WebDriver driver)  {
		BrowserActions.verifyElementDisplayed(driver, btnScheduler,"Scheduler");
		return this;
	}
	...
	public BatchProcessInfoPage verifyBatchProcessLastRunStatus(WebDriver driver,String batchProcess) {
		By btnLastRunStatus = By.xpath("//div[text()='"+batchProcess+"']//ancestor::td//following-sibling::td[contains(@id,'LastRunStatus')]");
		BrowserActions.waitForElementToDisplay(driver, btnLastRunStatus, "Last Run Status");
	...
	public BatchProcessInfoPage verifyRunStatusforExchangeRate(WebDriver driver,String batchProcess) {
		By btnBeforeLastRunStatusBy = By.xpath("//div[text()='"+batchProcess+"']//ancestor::td//following-sibling::td[contains(@id,'LastRun_Cell')]");
		BrowserActions.waitForElementToDisplay(driver, btnBeforeLastRunStatusBy, "Before Last Run");
		WebElement btnBeforeLastRunStatus = btnBeforeLastRunStatusBy.findElement(driver);
		String beforeText= btnBeforeLastRunStatus.getText();
		this.clickBatchProcessRunButton(driver, batchProcess);
		By btnAfterLastRunStatusBy = By.xpath("//div[text()='"+batchProcess+"']//ancestor::td//following-sibling::td[contains(@id,'LastRun_Cell')]");
		BrowserActions.waitForElementToDisplay(driver, btnBeforeLastRunStatusBy, "Before Last Run");
		WebElement btnAfterLastRunStatus = btnAfterLastRunStatusBy.findElement(driver);
	...
	public BatchProcessInfoPage verifyBatchProcessNextScheduledRun(WebDriver driver,String batchProcess) {
		By btnNextScheduleRun = By.xpath("//div[text()='"+batchProcess+"']//ancestor::td//following-sibling::td[contains(@id,'NextRun')]");
		BrowserActions.waitForElementToDisplay(driver, btnNextScheduleRun, "Next Scheduled Run");
		return this;
	}
	...
	public BatchProcessInfoPage verifyBatchProcessSchedule(WebDriver driver,String batchProcess)  {
		By btnSchedule = By.xpath("//div[text()='"+batchProcess+"']//ancestor::td//following-sibling::td[contains(@id,'ScheduleActions')]");//Financials Escalation
		BrowserActions.waitForElementToDisplay(driver, btnSchedule,"Schedule start and stop");
		return this;
	}
	...
	public ViewLogsPage clickViewLogsPage(WebDriver driver)  {
		BrowserActions.click(driver, lblViewLogsPage,"View Logs Page");
		Log.messageStep("View Logs is Clicked to view Details of View Logs",DriverManager.getDriver());
		return new ViewLogsPage(driver).get();
	}

	public IntentionalLoggingPage clickIntentionalLogging(WebDriver driver)  {
		BrowserActions.click(driver, lblIntentionalLogging,"Intentional Logging");
		Log.messageStep("Intentional Log is Clicked to view Details of Intentional Logs",DriverManager.getDriver());
		return new IntentionalLoggingPage(driver).get();
	}

	public ManagementBeansPage clickManagementBeans(WebDriver driver)  {
		BrowserActions.click(driver, lblManagementBeans,"Management Beans");
		Log.messageStep("Management Beans  Button is Clicked to view Details of Management Bean page",DriverManager.getDriver());
		return new ManagementBeansPage(driver).get();
	}
	public  StartableServicesPage  clickStartableServices(WebDriver driver)  {
		BrowserActions.click(driver, lblStartableServices,"Startable service");
		Log.messageStep("Startable Services Button is Clicked to view Details of Startable Services",DriverManager.getDriver());
		return new StartableServicesPage(driver).get();
	}
	...
	public BatchProcessInfoPage verifyBatchProcessScheduledStartAndStop(WebDriver driver,String batchProcess) {
		By btnNextScheduleRun = By.xpath("//div[text()='"+batchProcess+"']//ancestor::td//following-sibling::td[contains(@id,'ScheduleActions')]");
		BrowserActions.waitForElementToDisplay(driver, btnNextScheduleRun, "Scheduled Start and Stop");
		return this;
	}
	public InfoConfigurationPage clickInfoConfigurationPage(WebDriver driver)  {
		BrowserActions.click(driver, btnInfoConfigurationPages,"Info Configurtion page");
		return new InfoConfigurationPage(driver).get();
	}
	public BatchProcessInfoPage verifyNextScheduledRunProcessCompletionMonitor(WebDriver driver,String batchProcess) {
		By btnNextScheduleRunBy = By.xpath("//div[text()='"+batchProcess+"']//ancestor::td//following-sibling::td[contains(@id,'NextRun')]");
		BrowserActions.waitForElementToDisplay(driver, btnNextScheduleRunBy,"batch processes");
		WebElement btnNextScheduleRun = btnNextScheduleRunBy.findElement(driver);
		if(btnNextScheduleRun.getText().isBlank()) {
