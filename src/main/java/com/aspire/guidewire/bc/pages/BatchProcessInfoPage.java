...
public class BatchProcessInfoPage extends LoadableComponent<BatchProcessInfoPage> {
	...
	public BatchProcessInfoPage clickBatchProcessRunButton(WebDriver driver)  {
		BrowserActions.click(driver, btnRun_341,true,"Run_341");
		return this;
	}
	...
	public DownloadHistoryPage clickBatchProcessDownloadHistory(WebDriver driver,String batchProcess)  {
		By btnDownloadHistoryBy = By.xpath("//div[text()='"+batchProcess+"']//ancestor::td//following-sibling::td[contains(@id,'RunBatchWithoutNotify')]//child::div[text()='Download History']");
		BrowserActions.waitForElementToDisplay(driver, btnDownloadHistoryBy, "History download button");
	...
	public BatchProcessInfoPage clickBatchProcessRunButton(WebDriver driver,String batchProcess)  {
		...
		BrowserActions.waitForElementToDisplay(driver, btnRunBy, "Run button");
		WebElement btnRun = btnRunBy.findElement(driver);
		BrowserActions.click(driver,btnRun,1, batchProcess+"Run button");
	...
	public BatchProcessInfoPage verifyBatchProcessLastRun(WebDriver driver,String batchProcess) {
		By btnRunBy = By.xpath("//div[text()='"+batchProcess+"']//ancestor::td//following-sibling::td[contains(@id,'LastRun_Cell')]");
		BrowserActions.waitForElementToDisplay(driver, btnRunBy, "Last Run Button");
		return this;
	}
	...
	public BatchProcessInfoPage verifyBatchProcessLastRunStatus(WebDriver driver,String batchProcess) {
		By btnLastRunStatusBy = By.xpath("//div[text()='"+batchProcess+"']//ancestor::td//following-sibling::td[contains(@id,'LastRunStatus')]");
		BrowserActions.waitForElementToDisplay(driver, btnLastRunStatusBy, "Last run status button");
	...
	public BatchProcessInfoPage verifyBatchProcessNextScheduledRun(WebDriver driver,String batchProcess) {
		...
		BrowserActions.waitForElementToDisplay(driver, btnNextScheduleRunBy, "Next Schedule Run Button");
		return this;
	}
	...
	public BatchProcessInfoPage verifyBatchProcessSchedule(WebDriver driver,String batchProcess)  {
		By btnScheduleBy = By.xpath("//div[text()='"+batchProcess+"']//ancestor::td//following-sibling::td[contains(@id,'ScheduleActions')]");
		BrowserActions.waitForElementToDisplay(driver, btnScheduleBy, "Schedule start and stop");
		return this;
	}
	...
	public BatchProcessInfoPage verifyBatches(WebDriver driver)  {
		By rowsBy = By.tagName("tr");
		int size = BrowserActions.getWebElementSize(driver, rowsBy, "list of elements", 0.5);
		if ( size > 1) {
	...
	public BatchProcessInfoPage verifyBatchProcessScheduledStartAndStop(WebDriver driver,String batchProcess) {
		By btnNextScheduleRunBy = By.xpath("//div[text()='"+batchProcess+"']//ancestor::td//following-sibling::td[contains(@id,'ScheduleActions')]");
		BrowserActions.waitForElementToDisplay(driver, btnNextScheduleRunBy, "Schedule Run button");
		return this;
	}
	public BatchProcessInfoPage verifyNextScheduledRunProcessCompletionMonitor(WebDriver driver,String batchProcess) {
		By btnNextScheduleRunBy = By.xpath("//div[text()='"+batchProcess+"']//ancestor::td//following-sibling::td[contains(@id,'NextRun')]");
		BrowserActions.waitForElementToDisplay(driver, btnNextScheduleRunBy, "Next Schedule Button");
