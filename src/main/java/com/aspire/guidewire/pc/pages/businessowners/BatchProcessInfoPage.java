...
public class BatchProcessInfoPage extends LoadableComponent<BatchProcessInfoPage> {
	...
	@IFindBy(how = How.CSS, using = "input[name='BatchProcessInfo-BatchProcessScreen-BatchProcessesLV-61-Schedule']", AI = false)
	public WebElement inpCronSMHDOMMDOW_856;
	...
	public WebElement lnkReturnToPolicyCenter;

	@IFindBy(how = How.XPATH, using = "//div[text()='HandleUnresolvedContingency']//ancestor::td//following-sibling::td//descendant::div[contains(@id,'RunWriter')]", AI = false)
	public WebElement btnWorkQueueRunHandleUnresolvedContingency;

	@IFindBy(how = How.CSS, using = "div[id$='MenuLinks-ServerTools_WorkQueueInfo']", AI = false)
	public WebElement lnkWorkQueueInfo;
	...
	public BatchProcessInfoPage enterCronSMHDOMMDOW_856(WebDriver driver,String CronSMHDOMMDOW_856) {
		BrowserActions.type(driver, inpCronSMHDOMMDOW_856,CronSMHDOMMDOW_856, "CronSMHDOMMDOW_856");
		return this;
	}
	public BatchProcessInfoPage clickRunHandleUnresolvedContingency(WebDriver driver) {
		BrowserActions.click(driver,btnRunHandleUnresolvedContingency, "Run");
		return this;
	}
	public BatchProcessInfoPage clickReturnToPolicyCenter(WebDriver driver) {
		BrowserActions.click(driver,lnkReturnToPolicyCenter, "Policy center");
		return this;
	}
	public BatchProcessInfoPage clickRunWorkQueueHandleUnresolvedContingency(WebDriver driver) {
		BrowserActions.click(driver,btnWorkQueueRunHandleUnresolvedContingency, "Run Handle Unresolved Contingency");
		return this;
	}
	public BatchProcessInfoPage clickWorkQueueInfo(WebDriver driver) {
		BrowserActions.click(driver,lnkWorkQueueInfo, "Work Queue Info");
		return this;
	}
	...
	public BatchProcessInfoPage clickGotoBatchProcess(WebDriver driver) {
		BrowserActions.verifyElementDisplayed(driver, btnActions, "Action Button");
