...
public class BatchProcessInfoPage extends LoadableComponent<BatchProcessInfoPage> {
	...
	@IFindBy(how = How.XPATH, using = "//select[@name='BatchProcessInfo-BatchProcessScreen-BatchProcessesLV-ProcessUsageFilter']", AI = false)
	public WebElement drpValue; 

	@IFindBy(how = How.XPATH, using = "//select/option[@selected]", AI = false)
	public WebElement drpProcessValueSelected; 
	...
	public WorkQueueInfoPage clickWorkQueueInfo(WebDriver driver)  {
		BrowserActions.click(driver, btnWorkQueueInfo,"WorkQueue Info");
		return new WorkQueueInfoPage(driver).get();
	}
	
	/**
	 * Click Goto Batch process
	...
	public BatchProcessInfoPage verifyLastRun(WebDriver driver) {
		...
		BrowserActions.waitForElementToDisplay(driver, lastRunBy, "lastRun");  	
 		return this;	
	}
	/**
	...
	public BatchProcessInfoPage verifyLastRunStatus(WebDriver driver){
		...
		BrowserActions.waitForElementToDisplay(driver, lastRunStatusBy, "lastRunStatus");
		return this;
	}
	/**
	...
	/**
	 * Verify Refresh Button is Display or not
	 * @author vignesh
	 * @param driver
	 *  @return
	 */
	...
	/**
	 * Verify SuspendScheduler Button is Display or not
	 * @author vignesh
	 * @param driver
	 * @return
	 */
	...
	/**
	 * Verify Download Button is Display or not
	 * @author vignesh
	 * @param driver
	 * @return
	 */
	...
	/**
	 * Verify Dropdown is Display or not
	 * @author vignesh
	 * @param driver
	 * @return
	 */
	public BatchProcessInfoPage verifyDropDown(WebDriver driver, String expectedText)  {		
		BrowserActions.verifyElementTextIsDisplayedforSelcetedDropDown(driver, drpProcessUsageFilter, expectedText, true,expectedText + " dropdown should be selected based on the selection it should display other items");
		return this;
	}
