...
public class BuildingsAndLocationsPage extends LoadableComponent<BuildingsAndLocationsPage> {
	...
	@IFindBy(how = How.CSS, using = "div[id$='addExistingLocations']", AI = false)
	...
	@IFindBy(how = How.CSS, using = "div[id$='AddNewLocation']", AI = false)
	...
	@IFindBy(how = How.CSS, using = "div[id$='UnassignedAccountLocation']", AI = false)
	public WebElement lnkExistingAccountLocation;
	...
	public BuildingsAndLocationsPage clickAddBuildingDropdown(WebDriver driver)  {
		BrowserActions.click(driver, btnBuildingDropdown,0.5,"Drop Down  button");
	...
	public BuildingsAndLocationsPage clickExistingAccountLocation(WebDriver driver)  {
		BrowserActions.click(driver, lnkExistingAccountLocation, "ExistingAccountLocation");
		return this;
	}
	...
	public class NewBuildingPage extends LoadableComponent<NewBuildingPage> {
		...
		@IFindBy(how = How.CSS, using = "div[id$='BuildingPopup-ttlBar']", AI = false)
		public WebElement lblTtlBar;
		...
		public WebElement icnClassCodeSearch;
		...
		public NewBuildingPage enterDescription(WebDriver driver,String Description) {
			BrowserActions.type(driver, inpDescription,Description,0.5, "Description");
			return this;
		}
		...
		public NewBuildingPage clickNext(WebDriver driver)  {
			BrowserActions.click(driver, btnNext,"Next");
			return this;
		}
		public NewBuildingPage clickCodeSeachIcon(WebDriver driver)  {
			BrowserActions.click(driver, icnClassCodeSearch,"Class Code Search");
			return this;
		}
		public NewBuildingPage clickAddCoverages(WebDriver driver)  {
			BrowserActions.click(driver, btnAddCoverages,"Add Coverages");
			return this;
		}
	...
	public class SearchCoveragesPage extends LoadableComponent<SearchCoveragesPage> {
		...
		@IFindBy(how = How.CSS, using = "div[id$='CoveragePatternSearchScreen-ttlBar']", AI = false)
		public WebElement lblTtlBar;
		...
		public SearchCoveragesPage clickAddSelectedCoverages(WebDriver driver)  {
			BrowserActions.click(driver, btnAddSelectedCoverages,0.5,"AddSelectedCoverages");
			return this;
		}
	...
	public class ClassCodeSearchPage extends LoadableComponent<ClassCodeSearchPage> {
		...
		@IFindBy(how = How.XPATH, using ="//div[contains(@id,'Select')]//descendant::div[text()='Select']", AI = false)  
		...
		protected void isLoaded() {
			if (!isPageLoaded) {
				Assert.fail();
			}if (isPageLoaded && !(BrowserActions.waitForElementToDisplay(driver, inpClassification))) {
				Log.fail("Page did not open up. Site might be down.", driver);
			}elementLayer = new ElementLayer(driver);
		...
		public ClassCodeSearchPage selectCode(WebDriver driver)  {
