...
public class MovePoliciesToThisAccountPage extends LoadableComponent<MovePoliciesToThisAccountPage> {
	...
	@IFindBy(how = How.CSS, using = "input[name='AccountFile_MovePoliciesSelection-AccountFile_MovePoliciesSelectionLV-0-_Checkbox']", AI = false)
	public WebElement chkpoliciesCheckBox;
	
	@IFindBy(how = How.CSS, using = "input[name='AccountFile_MovePoliciesSelection-AccountFile_MovePoliciesSelectionLV-1-_Checkbox']", AI = false)
	public WebElement chkpoliciesCheckBox_1;

	@IFindBy(how = How.CSS, using = "div#AccountFile_MovePoliciesSelection-MovePoliciesButton", AI = false)
	public WebElement btnmovePoliciesToThisAccount;

	public MovePoliciesToThisAccountPage(){
	}

	public MovePoliciesToThisAccountPage(WebDriver driver) throws Exception{
		this.driver = driver;
...
}public MovePoliciesToThisAccountPage clickCompanynameisanexactmatch(WebDriver driver)  {
					BrowserActions.click(driver, chkCompanynameisanexactmatch,"Companynameisanexactmatch");
				    return this;
			}
public MovePoliciesToThisAccountPage enterAddress3(WebDriver driver,String Address3) {
		            BrowserActions.type(driver, inpAddress3,Address3, "Address3");
			        return this;
           }
public MovePoliciesToThisAccountPage enterAddress1(WebDriver driver,String Address1) {
		            BrowserActions.type(driver, inpAddress1,Address1, "Address1");
			        return this;
           }
public MovePoliciesToThisAccountPage enterAddress2(WebDriver driver,String Address2) {
		            BrowserActions.type(driver, inpAddress2,Address2, "Address2");
			        return this;
           }
public MovePoliciesToThisAccountPage enterProducer(WebDriver driver,String Producer) {
		            BrowserActions.type(driver, inpProducer,Producer, "Producer");
			        return this;
           }
public MovePoliciesToThisAccountPage enterParticle(WebDriver driver,String Particle) {
		            BrowserActions.type(driver, inpParticle,Particle, "Particle");
			        return this;
           }
public MovePoliciesToThisAccountPage enterAddress(WebDriver driver,String Address) {
		            BrowserActions.type(driver, inpAddress,Address, "Address");
			        return this;
           }
public MovePoliciesToThisAccountPage enterProducerCode(WebDriver driver,String ProducerCode) {
		            BrowserActions.type(driver, inpProducerCode,ProducerCode, "ProducerCode");
			        return this;
           }
public MovePoliciesToThisAccountPage clickSearch_3(WebDriver driver)  {
					BrowserActions.click(driver, btnSearch_3,"Search_3");
				    return this;
			}
public MovePoliciesToThisAccountPage enterAccountNumber(WebDriver driver,String AccountNumber) {
		            BrowserActions.type(driver, inpAccountNumber,AccountNumber, "AccountNumber");
			        return this;
           }
public MovePoliciesToThisAccountPage enterMiddlename(WebDriver driver,String Middlename) {
		            BrowserActions.type(driver, inpMiddlename,Middlename, "Middlename");
			        return this;
           }
public MovePoliciesToThisAccountPage enterZIPCode(WebDriver driver,String ZIPCode) {
		            BrowserActions.type(driver, inpZIPCode,ZIPCode, "ZIPCode");
			        return this;
           }
public MovePoliciesToThisAccountPage clickAutoFillIcon(WebDriver driver)  {
					BrowserActions.click(driver, btnAutoFillIcon,"AutoFillIcon");
				    return this;
			}
public MovePoliciesToThisAccountPage enterLastname(WebDriver driver,String Lastname) {
		            BrowserActions.type(driver, inpLastname,Lastname, "Lastname");
			        return this;
           }
public MovePoliciesToThisAccountPage clickFirstnameisanexactmatch(WebDriver driver)  {
					BrowserActions.click(driver, chkFirstnameisanexactmatch,"Firstnameisanexactmatch");
				    return this;
			}
public MovePoliciesToThisAccountPage clickSearch_1(WebDriver driver)  {
					BrowserActions.click(driver, btnSearch_1,"Search_1");
				    return this;
			}
public MovePoliciesToThisAccountPage enterCity(WebDriver driver,String City) {
		            BrowserActions.type(driver, inpCity,City, "City");
			        return this;
           }
public MovePoliciesToThisAccountPage clickAutoFillIcon_2(WebDriver driver)  {
					BrowserActions.click(driver, btnAutoFillIcon_2,"AutoFillIcon_2");
				    return this;
			}
public MovePoliciesToThisAccountPage selectPrefix(WebDriver driver,String Prefix)  {
					BrowserActions.selectDropDownByVisibleText(driver, drpPrefix,Prefix,"Prefix");
				    return this;
			}
public MovePoliciesToThisAccountPage clickLastnameisanexactmatch(WebDriver driver)  {
					BrowserActions.click(driver, chkLastnameisanexactmatch,"Lastnameisanexactmatch");
				    return this;
			}
public MovePoliciesToThisAccountPage enterCounty(WebDriver driver,String County) {
		            BrowserActions.type(driver, inpCounty,County, "County");
			        return this;
           }
public MovePoliciesToThisAccountPage clickSearch(WebDriver driver)  {
					BrowserActions.click(driver, btnSearch,"Search");
				    return this;
			}
public MovePoliciesToThisAccountPage enterName(WebDriver driver,String Name) {
		            BrowserActions.type(driver, inpName,Name, "Name");
			        return this;
           }
public MovePoliciesToThisAccountPage selectCountry(WebDriver driver,String Country)  {
					BrowserActions.selectDropDownByVisibleText(driver, drpCountry,Country,"Country");
				    return this;
			}
public MovePoliciesToThisAccountPage enterCompanyName(WebDriver driver,String CompanyName) {
		            BrowserActions.type(driver, inpCompanyName,CompanyName, "CompanyName");
			        return this;
           }
public MovePoliciesToThisAccountPage selectSuffix(WebDriver driver,String Suffix)  {
					BrowserActions.selectDropDownByVisibleText(driver, drpSuffix,Suffix,"Suffix");
				    return this;
			}
public MovePoliciesToThisAccountPage selectState(WebDriver driver,String State)  {
					BrowserActions.selectDropDownByVisibleText(driver, drpState,State,"State");
				    return this;
			}
public MovePoliciesToThisAccountPage enterTaxID(WebDriver driver,String TaxID) {
		            BrowserActions.type(driver, inpTaxID,TaxID, "TaxID");
			        return this;
           }
public MovePoliciesToThisAccountPage clickSelectOrganization(WebDriver driver)  {
					BrowserActions.click(driver, btnSelectOrganization,"SelectOrganization");
				    return this;
			}
public MovePoliciesToThisAccountPage enterIndustryCode(WebDriver driver,String IndustryCode) {
		            BrowserActions.type(driver, inpIndustryCode,IndustryCode, "IndustryCode");
			        return this;
           }
public MovePoliciesToThisAccountPage enterPhone(WebDriver driver,String Phone) {
		            BrowserActions.type(driver, inpPhone,Phone, "Phone");
			        return this;
           }
public MovePoliciesToThisAccountPage clickRelatedto9317777706(WebDriver driver)  {
					BrowserActions.click(driver, chkRelatedto9317777706,"Relatedto9317777706");
				    return this;
			}
public MovePoliciesToThisAccountPage clickReset(WebDriver driver)  {
					BrowserActions.click(driver, btnReset,"Reset");
				    return this;
			}
public MovePoliciesToThisAccountPage enterFirstname(WebDriver driver,String Firstname) {
		            BrowserActions.type(driver, inpFirstname,Firstname, "Firstname");
			        return this;
           }
public MovePoliciesToThisAccountPage clickSelect(WebDriver driver)  {
	BrowserActions.click(driver, btnSelect,"Account Select");
	return this;
}

public MovePoliciesToThisAccountPage clicKPoliciesCheckBox(WebDriver driver)  {
	BrowserActions.click(driver, chkpoliciesCheckBox,"Policies Check Box");
	return this;
}
public MovePoliciesToThisAccountPage clicKPoliciesCheckBox_1(WebDriver driver)  {
	BrowserActions.click(driver, chkpoliciesCheckBox_1,"Policies Check Box");
	return this;
}

public MovePoliciesToThisAccountPage clicKMovePoliciesToThisAccountButton(WebDriver driver)  {
	BrowserActions.click(driver, btnmovePoliciesToThisAccount,1,"Move Policies To This Account Button");
	return this;
}
