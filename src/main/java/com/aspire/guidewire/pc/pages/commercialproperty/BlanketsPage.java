...
public class BlanketsPage extends LoadableComponent<BlanketsPage> {
	...
	@IFindBy(how = How.CSS, using = "div[id$='CPBlanketScreen-ttlBar']", AI = false)
	...
	@IFindBy(how = How.CSS, using = "#SubmissionWizard-LOBWizardStepGroup-LineWizardStepSet-CPBlanketScreen-CPBlanketPanelSet-CPBlanket_tb-AddBlanket>div[role='button']", AI = false)
	...
	public BlanketsPage(WebDriver driver,int timeout){
		this.driver = driver;
	...
	public class BlanketDetailsPage extends LoadableComponent<BlanketDetailsPage> {
		...
		//	public CPBlanketPopup cpblanketpopupTable;
		...
		@IFindBy(how = How.CSS, using = "div[id='SubmissionWizard-Next']", AI = false)
		public WebElement btnNext;
		...
		public BlanketDetailsPage(WebDriver driver){
			...
			PageFactory.initElements(finder, this);
			//		cpblanketpopupTable = new CPBlanketPopup();
		}
		...
		public BlanketDetailsPage clickShowCoverages(WebDriver driver)  {
			BrowserActions.click(driver, btnShowCoverages,1,"ShowCoverages");
			return this;
		}
		...
		public BlanketDetailsPage clickBlanketCoverageCheckBox(WebDriver driver) {
			BrowserActions.click(driver,chkBlanketCoverage,true, "ok button");
			return this;
		}
	}
