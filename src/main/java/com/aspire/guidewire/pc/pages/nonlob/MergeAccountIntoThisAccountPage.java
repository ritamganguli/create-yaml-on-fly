...
public class MergeAccountIntoThisAccountPage extends LoadableComponent<MergeAccountIntoThisAccountPage> {
	...
	@IFindBy(how = How.CSS, using = "div[id$='MergeAccountsSelection-MergeAccounts']", AI = false)
	public WebElement btnMergeAccounts;

	public MergeAccountIntoThisAccountPage(){
	}

	public MergeAccountIntoThisAccountPage(WebDriver driver){
		this.driver = driver;
...
}public MergeAccountIntoThisAccountPage clickCompanynameisanexactmatch(WebDriver driver)  {
					BrowserActions.click(driver, chkCompanynameisanexactmatch,"Companynameisanexactmatch");
				    return this;
			}
public MergeAccountIntoThisAccountPage enterAddress3(WebDriver driver,String Address3) {
		            BrowserActions.type(driver, inpAddress3,Address3, "Address3");
			        return this;
           }
public MergeAccountIntoThisAccountPage enterAddress1(WebDriver driver,String Address1) {
		            BrowserActions.type(driver, inpAddress1,Address1, "Address1");
			        return this;
           }
public MergeAccountIntoThisAccountPage enterAddress2(WebDriver driver,String Address2) {
		            BrowserActions.type(driver, inpAddress2,Address2, "Address2");
			        return this;
           }
public MergeAccountIntoThisAccountPage enterProducer(WebDriver driver,String Producer) {
		            BrowserActions.type(driver, inpProducer,Producer, "Producer");
			        return this;
           }
public MergeAccountIntoThisAccountPage enterParticle(WebDriver driver,String Particle) {
		            BrowserActions.type(driver, inpParticle,Particle, "Particle");
			        return this;
           }
public MergeAccountIntoThisAccountPage enterAddress(WebDriver driver,String Address) {
		            BrowserActions.type(driver, inpAddress,Address, "Address");
			        return this;
           }
public MergeAccountIntoThisAccountPage enterProducerCode(WebDriver driver,String ProducerCode) {
		            BrowserActions.type(driver, inpProducerCode,ProducerCode, "ProducerCode");
			        return this;
           }
public MergeAccountIntoThisAccountPage clickSearch_3(WebDriver driver)  {
					BrowserActions.click(driver, btnSearch_3,"Search_3");
				    return this;
			}
public MergeAccountIntoThisAccountPage enterAccountNumber(WebDriver driver,String AccountNumber) {
		            BrowserActions.type(driver, inpAccountNumber,AccountNumber, "AccountNumber");
			        return this;
           }
public MergeAccountIntoThisAccountPage enterMiddlename(WebDriver driver,String Middlename) {
		            BrowserActions.type(driver, inpMiddlename,Middlename, "Middlename");
			        return this;
           }
public MergeAccountIntoThisAccountPage enterZIPCode(WebDriver driver,String ZIPCode) {
		            BrowserActions.type(driver, inpZIPCode,ZIPCode, "ZIPCode");
			        return this;
           }
public MergeAccountIntoThisAccountPage clickAutoFillIcon(WebDriver driver)  {
					BrowserActions.click(driver, btnAutoFillIcon,"AutoFillIcon");
				    return this;
			}
public MergeAccountIntoThisAccountPage enterLastname(WebDriver driver,String Lastname) {
		            BrowserActions.type(driver, inpLastname,Lastname, "Lastname");
			        return this;
           }
public MergeAccountIntoThisAccountPage clickFirstnameisanexactmatch(WebDriver driver)  {
					BrowserActions.click(driver, chkFirstnameisanexactmatch,"Firstnameisanexactmatch");
				    return this;
			}
public MergeAccountIntoThisAccountPage clickSearch_1(WebDriver driver)  {
					BrowserActions.click(driver, btnSearch_1,"Search_1");
				    return this;
			}
public MergeAccountIntoThisAccountPage enterCity(WebDriver driver,String City) {
		            BrowserActions.type(driver, inpCity,City, "City");
			        return this;
           }
public MergeAccountIntoThisAccountPage clickAutoFillIcon_2(WebDriver driver)  {
					BrowserActions.click(driver, btnAutoFillIcon_2,"AutoFillIcon_2");
				    return this;
			}
public MergeAccountIntoThisAccountPage selectPrefix(WebDriver driver,String Prefix)  {
					BrowserActions.selectDropDownByVisibleText(driver, drpPrefix,Prefix,"Prefix");
				    return this;
			}
public MergeAccountIntoThisAccountPage clickLastnameisanexactmatch(WebDriver driver)  {
					BrowserActions.click(driver, chkLastnameisanexactmatch,"Lastnameisanexactmatch");
				    return this;
			}
public MergeAccountIntoThisAccountPage enterCounty(WebDriver driver,String County) {
		            BrowserActions.type(driver, inpCounty,County, "County");
			        return this;
           }
public MergeAccountIntoThisAccountPage clickSearch(WebDriver driver)  {
					BrowserActions.click(driver, btnSearch,1,"Search");
				    return this;
			}
public MergeAccountIntoThisAccountPage enterName(WebDriver driver,String Name) {
		            BrowserActions.type(driver, inpName,Name, "Name");
			        return this;
           }
public MergeAccountIntoThisAccountPage selectCountry(WebDriver driver,String Country)  {
					BrowserActions.selectDropDownByVisibleText(driver, drpCountry,Country,"Country");
				    return this;
			}
public MergeAccountIntoThisAccountPage enterCompanyName(WebDriver driver,String CompanyName) {
		            BrowserActions.type(driver, inpCompanyName,CompanyName, "CompanyName");
			        return this;
           }
public MergeAccountIntoThisAccountPage selectSuffix(WebDriver driver,String Suffix)  {
					BrowserActions.selectDropDownByVisibleText(driver, drpSuffix,Suffix,"Suffix");
				    return this;
			}
public MergeAccountIntoThisAccountPage selectState(WebDriver driver,String State)  {
					BrowserActions.selectDropDownByVisibleText(driver, drpState,State,"State");
				    return this;
			}
public MergeAccountIntoThisAccountPage enterTaxID(WebDriver driver,String TaxID) {
		            BrowserActions.type(driver, inpTaxID,TaxID, "TaxID");
			        return this;
           }
public MergeAccountIntoThisAccountPage clickSelectOrganization(WebDriver driver)  {
					BrowserActions.click(driver, btnSelectOrganization,"SelectOrganization");
				    return this;
			}
public MergeAccountIntoThisAccountPage enterIndustryCode(WebDriver driver,String IndustryCode) {
		            BrowserActions.type(driver, inpIndustryCode,IndustryCode, "IndustryCode");
			        return this;
           }
public MergeAccountIntoThisAccountPage enterPhone(WebDriver driver,String Phone) {
		            BrowserActions.type(driver, inpPhone,Phone, "Phone");
			        return this;
           }
public MergeAccountIntoThisAccountPage clickRelatedto9317777706(WebDriver driver)  {
					BrowserActions.click(driver, chkRelatedto9317777706,"Relatedto9317777706");
				    return this;
			}
public MergeAccountIntoThisAccountPage clickReset(WebDriver driver)  {
					BrowserActions.click(driver, btnReset,"Reset");
				    return this;
			}
public MergeAccountIntoThisAccountPage enterFirstname(WebDriver driver,String Firstname) {
		            BrowserActions.type(driver, inpFirstname,Firstname, "Firstname");
			        return this;
           }
public MergeAccountIntoThisAccountPage clickSelectButton(WebDriver driver)  {
	BrowserActions.click(driver, btnSelect,"Account Select");
	return this;
}

/**
 * Click Merge Account to this Account Button
 * @param driver 
 * @return
 */
public MergeAccountIntoThisAccountPage clicKMergeAccountsToThisAccountButton(WebDriver driver) throws InterruptedException  {
	BrowserActions.click(driver, btnMergeAccounts,1,"Merge Account To This Account Button");
