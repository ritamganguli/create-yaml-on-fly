...
import com.aspire.guidewire.utils.MobileEmulationUserAgentConfiguration;
...
public class SauceLabsCapabilitiesConfiguration implements IGridCapabilitiesConfiguration {
	...
	public DesiredCapabilities getDesiredCapabilities() {		
		...
		if (System.getProperty("SELENIUM_DRIVER") != null && System.getProperty("SELENIUM_DRIVER").contains("internet explorer") ){
			...
			iecaps.setCapability(InternetExplorerDriver.NATIVE_EVENTS, false);
		...
		if (System.getProperty("SELENIUM_DRIVER") != null && System.getProperty("SELENIUM_DRIVER").toLowerCase().contains("chrome") ){
	 ...
	 */
	public ChromeOptions getUserAgentDesiredCapabilities(SauceLabsCapabilitiesConfiguration caps, String deviceName, String userAgent) {
